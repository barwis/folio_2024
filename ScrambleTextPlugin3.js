...
!(function (D, u) {
    ...
    function emojiSafeSplit(D, u, F, C) {
        ...
        for (var e, E, t = [], n = D.length, i = 0; i < n; i++)
            ((55296 <= (E = D.charAt(i)).charCodeAt(0) &&
                E.charCodeAt(0) <= 56319) ||
                (65024 <= D.charCodeAt(i + 1) &&
                    D.charCodeAt(i + 1) <= 65039)) &&
                ((e =
                    ((D.substr(i, 12).split(warningText) || [])[1] || '')
                        .length || 2),
                (E = D.substr(i, e)),
                (i += e - (t.emoji = 1))),
                t.push(
            ...
            init: function init(D, u, F) {
                if (
                    ...
                    return (
                        ...
                        (r.charsHaveEmoji =
                            !!u.chars && !!emojiSafeSplit(u.chars).emoji),
                        (r.length = t
                            ? r.original.length
                            : r.original.join(C).length),
                        (r.lengthDif =
                            (t ? r.text.length : r.text.join(C).length) -
                            r.length),
                        (r.fillChar =
                        ...
                        (e = r.length + Math.max(r.lengthDif, 0)) > E.length &&
                            E.grow(e),
