...
!(function (D, u) {
    ...
    function F(u, e, t, F, i, n, s) {
        ...
        G &&
            ...
            K &&
                (Q ? (u.style.display = Q) : u.style.removeProperty('display')),
            B(t, H),
            P && B(F, O),
            B(i, j);
    }
            ...
            if (((E = F.charAt(n)), c && (o = c(F.substr(n), u.specialChars))))
                ...
                '{' === E && '{{LT}}' === F.substr(n, 6)
                    ...
                    : (55296 <= E.charCodeAt(0) && E.charCodeAt(0) <= 56319) ||
                      (65024 <= F.charCodeAt(n + 1) &&
                          F.charCodeAt(n + 1) <= 65039)
                    ? ((C =
                          ((F.substr(n, 12).split(someText) || [])[1] || '')
                              .length || 2),
                      (i +=
                          d && ' ' !== E
                              ? t() + F.substr(n, C) + '</' + l + '>'
