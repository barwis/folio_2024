...
!(function (e, t) {
    ...
    function A(e, t, o, n, i, r, a) {
        return (
            (e.a = t), (e.b = o), (e.c = n), (e.d = i), (e.e = r), (e.f = a), e
        );
    }
    var g,
        u,
        ...
        D = function _getDocScrollTop() {
            return (
                u.pageYOffset || g.scrollTop || r.scrollTop || a.scrollTop || 0
            );
        },
    ...
    function Ua(i, r, e, t, a, o) {
        ...
        if (r)
            if (1 !== a && r instanceof Array) {
                if (((c.end = n = []), (l = r.length), $(r[0])))
                    for (s = 0; s < l; s++) n[s] = ra(r[s], a);
    ...
    function _a(e) {
        if (X() && document.body) {
            ...
            (ve = window),
                ...
                (Se = t && -1 !== t.userAgent.toLowerCase().indexOf('android')),
                (Te =
    ...
    var me,
        ...
        R = function _getElementBounds(e, t) {
            ...
            return e === t
                ...
                : ((s = (a = getGlobalMatrix(t, !0).multiply(
                      getGlobalMatrix(e)
                  )).apply({ x: o, y: i })),
                  (l = a.apply({ x: n, y: i })),
                  (c = a.apply({ x: n, y: r })),
            ...
            (o.dispatchEvent = function dispatchEvent(t) {
                ...
                return (
                    (this._listeners[t] || []).forEach(function (e) {
                        return (
                            !1 === e.call(n, { type: t, target: n.target }) &&
                            (o = !1)
                        );
                    }),
                    o
    ...
    function Draggable(g, p) {
        ...
        (e = Qe.call(this) || this),
            we || _a(1),
            (g = _e(g)[0]),
            (e.styles = Pe && Pe(g, 'transform,left,top')),
            (De = De || me.plugins.inertia),
            (e.vars = p = ra(p || {})),
            (e.target = g),
        ...
        function Ai(e) {
                    ...
                    te = !1,
                        ...
                        We.scrollLeft =
                            null != ve.pageXOffset
                                ...
                                : de.body.scrollLeft,
                        i = q.pointerX - We.scrollLeft,
                        r = q.pointerY - We.scrollTop;
                    c && !o;

                )
                    (t = (o = Ge(c.parentNode)) ? We : c.parentNode),
                        (n = o
                            ? {
                                  bottom: Math.max(
                                      be.clientHeight,
            ...
            if (P) {
                ...
                G
                    ...
                    : h
                    ? (j && ((q.deltaY = u - h.top()), h.top(u)),
                      U && ((q.deltaX = p - h.left()), h.left(p)))
                    : W
                    ? (j &&
                          ((q.deltaY = u - parseFloat(le.y)),
                          (le.y = u + 'px')),
                      U &&
                          ((q.deltaX = p - parseFloat(le.x)),
                          (le.x = p + 'px')),
                      le.renderTransform(1, le))
                    : (j &&
        ...
        function Bi(e, t) {
            ...
            g._gsap || (le = me.core.getCache(g)),
                ...
                W
                    ...
                    : ((q.y =
                          parseFloat(g.style.top || ((n = Na(g)) && n.top)) ||
                          0),
                ...
                (L || z || X) &&
                    ...
                    (X &&
                        ((Fe.x = q.x),
                        (Fe.y = q.y),
                        (o = X(Fe)).x !== q.x && ((q.x = o.x), (P = !0)),
                        o.y !== q.y && ((q.y = o.y), (P = !0))),
                    L &&
                        (o = L(q.x)) !== q.x &&
                        ((q.x = o), G && (q.rotation = o), (P = !0)),
                    z && ((o = z(q.y)) !== q.y && (q.y = o), (P = !0))),
                P && Ai(!0),
                e ||
                    ((q.deltaX = q.x - i),
                    (q.deltaY = q.y - r),
        ...
        function Ei() {
            ...
            (k = !1),
                h
                    ? (h.calibrate(),
                      (q.minX = D = -h.maxScrollLeft()),
                      (q.minY = E = -h.maxScrollTop()),
                      (q.maxX = S = q.maxY = A = 0),
                      (k = !0))
                    : p.bounds &&
                      ...
                      G
                          ? ((q.minX = D = e.left),
                            (q.maxX = S = e.left + e.width),
                            (q.minY = E = q.maxY = A = 0))
                          : _(p.bounds.maxX) && _(p.bounds.maxY)
                          ? ((t = Ra(g, g.parentNode)),
                            (q.minX = D =
                                Math.round(Sh(V, 'px') + e.left - t.left)),
                            (q.minY = E =
                                Math.round(Sh(Q, 'px') + e.top - t.top)),
                            (q.maxX = S = Math.round(D + (e.width - t.width))),
                            (q.maxY = A =
                                Math.round(E + (e.height - t.height))))
                          : ((e = p.bounds),
                            (q.minX = D = e.minX),
                            (q.minY = E = e.minY),
                            (q.maxX = S = e.maxX),
                            (q.maxY = A = e.maxY)),
                      S < D && ((q.minX = S), (q.maxX = S = D), (D = q.minX)),
                      A < E && ((q.minY = A), (q.maxY = A = E), (E = q.minY)),
                      G && ((q.minRotation = D), (q.maxRotation = S)),
                      (k = !0)),
                p.liveSnap &&
                    ((o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
                    (n = Xe(o) || Z(o)),
                    G
                        ? ((L = Ci(n ? o : o.rotation, D, S, 1)), (z = null))
                        : o.points
                        ? (X = (function buildPointSnapFunc(
                              l,
                              s,
                              c,
                              d,
        ...
        function Hi(e, t) {
            ...
            e && De
                ? (!0 === e &&
                      ...
                      G
                          ? (e.rotation = Ua(q, n ? o : o.rotation, S, D, 1, t))
                          : (U &&
                                (e[V] = Ua(
                                    q,
        ...
        function Ii(e) {
            var t,
                o = B;
            (B = getGlobalMatrix(g.parentNode, !0)),
                e &&
                    q.isPressed &&
                    !B.equals(o || new fe()) &&
        ...
        function Ji() {
            ...
            W &&
                ...
                (y = Ve.x),
                (w = Ve.y),
                P && (ge(q.pointerX, q.pointerY), Ai(!0)),
                (d = getGlobalMatrix(g)),
                h
                    ? (Ei(), (M = h.top()), (T = h.left()))
                    : (pe() ? (Bi(!0, !0), Ei()) : q.applyBounds(),
                      G
                          ? ((e = g.ownerSVGElement
                                ? [
                                      le.xOrigin - g.getBBox().x,
                                      le.yOrigin - g.getBBox().y,
                                  ]
                                : (Na(g)[ze] || '0 0').split(' ')),
                            (C = q.rotationOrigin =
        ...
        function Mi(e, t) {
            ...
            if (
                ...
                if (
                    ...
                    (x = ae.call(q, e.target) && !1 === p.dragClickables && !t))
                )
                    return (
        ...
        function Ri(e) {
            var t = Re(),
                ...
                n = t - ee < 50,
                i = o && I === se,
                r = q.pointerEvent && q.pointerEvent.defaultPrevented,
                a = o && c === se,
            ...
            if (
                ...
                return s && i && (c = se), void (I = se);
            (q.isPressed || n || o) && ((s && e.detail && o && !r) || Ba(e)),
                o ||
                    n ||
                    F ||
        ...
        var u,
            ...
            ue = function onMove(e) {
                ...
                if (u && !ke && q.isPressed && e) {
                    ...
                    R &&
                    !Y &&
                    ((Ve.x = e.pageX - (ce ? Ga(de) : 0)),
                    (Ve.y = e.pageY - (ce ? Fa(de) : 0)),
                    B && B.apply(Ve, Ve),
                    (o = Ve.x),
                    (n = Ve.y),
            ...
            ge = function setPointerPosition(e, t, o) {
                ...
                (q.pointerX = e),
                    ...
                    ce && ((e -= Ga(de)), (t -= Fa(de))),
                    G
                        ? ((a = Math.atan2(C.y - t, e - C.x) * Be),
                          180 < (s = q.y - a)
                              ? ((M -= 360), (q.y = a))
                              : s < -180 && ((M += 360), (q.y = a)),
                          (r =
                              q.x !== T || Math.abs(M - a) > K
                                  ? ((q.y = a), T + (M - a) * c)
                                  : T))
                        : (B &&
                              ((l = e * B.a + t * B.c + B.e),
                    ...
                    k &&
                        (S < r
                            ? (r = S + Math.round((r - S) * d))
                            : r < D && (r = D + Math.round((r - D) * d)),
                        G ||
                            (A < a
                                ? (a = Math.round(A + (a - A) * d))
                                : a < E && (a = Math.round(E + (a - E) * d)))),
                    (q.x === r && (q.y === a || G)) ||
                        (G
                            ? ((q.endRotation = q.x = q.endX = r), (P = !0))
                            : (j && ((q.y = q.endY = a), (P = !0)),
                              U && ((q.x = q.endX = r), (P = !0))),
            ...
            he = function onRelease(e, t) {
                if (
                    ...
                    return (
                        c && s
                            ? (Ba(s), (O = !0), Qa(q, 'release', 'onRelease'))
                            : s && !l
                            ? ((O = !1),
                              N &&
                                  (p.snap || p.bounds) &&
                                  Hi(p.inertia || p.throwProps),
                              Qa(q, 'release', 'onRelease'),
                              (Se && 'touchmove' === s.type) ||
        ...
        return (
                ...
                var o,
                    ...
                    l =
                        'velocity' === e && De
                            ...
                            : 'start';
                return (
                    'element' === l && ((a = Pa(q.target)), (s = Pa(e))),
                    (o =
                        'start' === l
                            ? q.x - T
                            : 'velocity' === l
                ...
                if ((Bi(!0), Ei(), k && !pe())) {
                    if (
                        ...
                        (q.x !== o || q.y !== n) &&
                            ((i = !0),
                            (q.x = q.endX = o),
                            G ? (q.endRotation = o) : (q.y = q.endY = n),
                            Ai((P = !0)),
                        ...
                        for (
                            ...
                            (a = (s = Ge(r.parentNode)) ? We : r.parentNode),
                                j &&
            ...
            (e.update = function (e, t, o) {
                ...
                return (
                    Ii(!t),
                    e ? q.applyBounds() : (P && o && Ai(!0), Bi(!0)),
                    t && (ge(q.pointerX, q.pointerY), P && Ai(!0)),
                    q.isPressed &&
                        !t &&
                        ((U && 0.01 < Math.abs(a - q.x)) ||
                            (j && 0.01 < Math.abs(s - q.y) && !G)) &&
                        Ji(),
                    q.autoScroll &&
            ...
            (e.enable = function (e) {
                ...
                if (
                    ...
                    me.utils.checkPrefix('touchCallout') &&
                        (i.touchCallout = 'none'),
                    'soft' !== e)
                ) {
                    for (
                        ...
                        (n = J[o]),
                            ...
                            p.allowContextMenu || za(n, 'contextmenu', zi);
                    Wa(J, !1);
                }
                return (
                    Ha(g, Qi),
            ...
            ~o.indexOf('scroll') &&
                ...
                (g.style.overflowY = j && !Te ? 'auto' : 'hidden'),
                (g.style.overflowX = U && !Te ? 'auto' : 'hidden'),
                (g = h.content)),
            G ? (n.rotation = 1) : (U && (n[V] = 1), j && (n[Q] = 1)),
    ...
    function Lb(e, t, o) {
        var n = j.createElementNS
            ? j.createElementNS('svg' === e ? de : pe, e)
            : j.createElement(e);
        return (
            t && (ub(t) && (t = j.querySelector(t)), t.appendChild(n)),
            'svg' === e &&
                (n.setAttribute('xmlns', de),
                n.setAttribute('xmlns:xlink', pe)),
            o && (n.style.cssText = o),
            n
        );
    }
    function Mb() {
        j.selection
            ? j.selection.empty()
            : I.getSelection && I.getSelection().removeAllRanges();
    }
    function Ob(e, t) {
        var o = 0,
            ...
            return (
                (i = function handler(e) {
                    'select' !== e.target.nodeName.toLowerCase() && e.type === r
                        ? (e.stopPropagation(),
                          Ue && (e.preventDefault(), o.call(t, e)))
                        : e.type !== r && o.call(t, e),
                        (Ue = !0);
                }),
    ...
    function Wb(e, t, o, n) {
        ...
        for (t += ''; -1 < --a; )
            if (r[a].innerHTML === t || r[a].value === t)
                return (
                    (e.selectedIndex = a), (o.innerHTML = r[a].innerHTML), r[a]
                );
        n &&
            ((i = Lb('option', e)).setAttribute('value', t),
        ...
        (Q = e || tb()),
            U ||
                (Q &&
                    ...
                    (K = j.documentElement),
                    (I = window),
                    (re = Q.core.context || function () {}),
                    Q.registerPlugin(V),
                    ((O = Q.globalTimeline)._sort = !0),
                    ...
                    (O.killTweensOf = function (e, t, o) {
                        q.killTweensOf(e, t, o),
                            q.killTweensOf.call(O, e, t, o);
                    }),
                    (ne._start = Q.ticker.time),
                    Q.ticker.add(function (e) {
                        return ne.render(e - ne._start);
                    }),
                    (O._start += O._time),
                    (q._start = O._time = O._tTime = 0),
                    ...
                    ie(2, function () {
                        var e, t, o;
                        if (!te)
                            for (Yb(), e = q._first, o = q._start; e; )
                                (t = e._next),
                                    e._tDur !== e._tTime ||
                                    (!e._dur && 1 !== e.progress())
                                        ...
                                        : e.kill(),
                                    (e = t);
                        2 < Ze.globalRecordingTime
                            ? ie(Ze.globalRecordingTime - 2, function () {
                                  te && te.update(),
    ...
    var Q,
        ...
        G = Ab(103, 115, 97, 112, 46, 99, 111, 109),
        ce = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/,
        ...
        Ue = !0,
        Ze = function GSDevTools(r) {
            U ||
                (ac(),
                Q || console.warn('Please gsap.registerPlugin(GSDevTools)')),
                (this.vars = r = r || {}),
                r.animation &&
                    (
                ...
                (r.id = r.id || (ub(r.animation) ? r.animation : ue++)),
                (ge[r.id + ''] = this),
            ...
            function fp() {
                var e,
                    ...
                    o = (function _getChildrenOf(e, t) {
                        for (
                            var o = [], n = 0, i = Q.core.Tween, r = e._first;
                            r;
                            ...
                            r instanceof i
                                ? r.vars.id && (o[n++] = r)
                                : (t && r.vars.id && (o[n++] = r),
                                  (n = (o = o.concat(_getChildrenOf(r, t)))
                                      .length)),
                                (r = r._next);
                        return o;
                ...
                for (
                    ...
                    ((e = n[t] || Lb('option', A)).animation = o[t]),
                        (i =
                            t && o[t].vars.id === o[t - 1].vars.id ? i + 1 : 0),
                        e.setAttribute(
                            'value',
                            (e.innerHTML =
                                o[t].vars.id +
            ...
            function gp(e) {
                ...
                if (
                    ...
                    if (
                        (i && ((i._inProgress = S), (i._outProgress = D)),
                        (i = e),
                        v &&
                            ((n = v.timeScale()),
                            v._targets &&
                                ...
                                (a.resume(), v.kill())),
                        (S = i._inProgress || 0),
                        (D = i._outProgress || 100),
                        (M.style.left = S + '%'),
                        (k.style.left = D + '%'),
                        c &&
                            (mo('animation', i.vars.id),
                            mo('in', S),
                            mo('out', D)),
                        (s = 0),
                        (o = r.maxDuration || Math.min(1e3, Ob(i))),
                        i === q || r.globalSync)
                    ) {
                        if (
                            (Yb(),
                        ...
                        if (
                            (te === p && (te = null),
                            (s = Math.min(S * i.duration(), i.time())),
                            i !== a && a)
                        ) {
                            for (
                                99999999 < (l = (t = i).totalDuration()) &&
                    ...
                    (_.innerHTML = v.duration().toFixed(2)),
                        Wb(A, i.vars.id, E);
                }
            }
            function ip(e) {
                gp(A.options[A.selectedIndex].animation),
            ...
            function rp(e) {
                ...
                t &&
                    ((t._inProgress = no('in') || 0),
                    (t._outProgress = no('out') || 100)),
                    r.paused && I(),
                    (i = null),
                    gp(a || t || q);
                var o = r.timeScale || no('timeScale'),
                    n = t === i;
                o && (Wb(z, o, X, o + 'x'), v.timeScale(o)),
                    100 ===
                        (S =
                            ('inTime' in r
                                ? Qb(r.inTime, i, 0, 0)
                        ...
                        !r.animation &&
                        t &&
                        (gp(q), (S = Qb(r.inTime, i, 0, 0) || 0)),
                    S &&
                        ((M.style.left = S + '%'),
                        (M.style.display = k.style.display = 'block')),
                    (D =
                        ('outTime' in r
                            ? Qb(r.outTime, i, 100, S)
                            : n
                            ? t._outProgress
                            : 0) || 100) < S && (D = 100),
                    100 !== D &&
                        ((k.style.left = D + '%'),
                        (M.style.display = k.style.display = 'block')),
                    (d = 'loop' in r ? r.loop : no('loop')) && dp(!0),
                    r.paused && v.progress(S / 100, !0).pause(),
                    se &&
                        i === q &&
                        le &&
                        r.globalSync &&
            ...
            var u,
                ...
                n = (function _createRootElement(e, t, o) {
                    ae ||
                        ...
                        (ae = !0)),
                        ub(e) && (e = j.querySelector(e));
                    var n = Lb(
                        'div',
                        e || K.getElementsByTagName('body')[0] || K
                    );
                    return (
                        n.setAttribute(
                            'class',
                            'gs-dev-tools' + (t ? ' minimal' : '')
                        ),
                        (n.innerHTML =
                ...
                z = lo('.time-scale select'),
                X = lo('.time-scale-label'),
                B = V.create(x, {
                    type: 'x',
                    cursor: 'ew-resize',
                ...
                N = V.create(M, {
                    ...
                    onRelease: function onRelease() {
                        S < 0 && (S = 0),
                            ...
                            (M.style.left = S + '%'),
                            mo('in', S),
                            Q.set(M, { x: 0, data: 'root', display: 'block' }),
                            C || v.resume();
                    },
                })[0],
                R = V.create(k, {
                    ...
                    onRelease: function onRelease() {
                        100 < D && (D = 100),
                            ...
                            (k.style.left = D + '%'),
                            mo('out', D),
                            Q.set(k, { x: 0, data: 'root', display: 'block' }),
                            m || (H(), v.resume());
                    },
                })[0],
                    ...
                    if (!B.isPressed || !0 === e) {
                        var t,
                            ...
                            n =
                                i._repeat &&
                                i._rDelay &&
                                i.totalTime() % (i.duration() + i._rDelay) >
                                    i.duration();
                        100 < o && (o = 100),
                            D <= o
                                ? !d || v.paused() || B.isDragging
                                    ? ((o === D && -1 !== i._repeat) ||
                                          ((o = D), v.progress(o / 100)),
                                      !C &&
                                          (D < 100 ||
                                              1 === i.totalProgress() ||
                                              -1 === i._repeat) &&
                                ...
                                : o < S && ((o = S), v.progress(o / 100, !0)),
                            (o === T && !0 !== e) ||
                                ((y.style.left = S + '%'),
                                (y.style.width = Math.max(0, o - S) + '%'),
                                (x.style.left = o + '%'),
            ...
            Ub(A, 'change', ip),
                Ub(A, 'mousedown', fp),
                Ub(t, 'mousedown', O),
                Ub(lo('.seek-bar'), 'mousedown', $o),
                Ub(lo('.rewind'), 'mousedown', cp),
                Ub(P, 'mousedown', ep),
                Ub(z, 'change', jp),
                'auto' === r.visibility
                    ? (Ub(n, 'mouseout', mp), Ub(n, 'mouseover', op))
                ...
                Q.set(x, { xPercent: -50, x: 0, data: 'root' }),
                Q.set(M, { xPercent: -100, x: 0, data: 'root' }),
                (M._gsIgnore =
                    k._gsIgnore =
                    x._gsIgnore =
                    t._gsIgnore =
                    P._gsIgnore =
                        !0),
                Q.killTweensOf([M, k, x]),
                rp(se),
                se && ie(1e-4, rp, [!1], this),
                Q.ticker.add(Y),
                ...
                (this.kill = this.revert =
                    function () {
                        Vb(A, 'change', ip),
                            Vb(A, 'mousedown', fp),
                            Vb(t, 'mousedown', O),
                            Vb(lo('.seek-bar'), 'mousedown', $o),
                            Vb(lo('.rewind'), 'mousedown', cp),
                            Vb(P, 'mousedown', ep),
                            Vb(z, 'change', jp),
                            B.disable(),
                            N.disable(),
                ...
                (this.minimal = function (e) {
                    ...
                    e
                        ...
                        B.isPressed &&
                            ((f = !0),
                            B.endDrag(B.pointerEvent),
                            (f = !1),
                            (t = 100 * v.progress()),
                            (y.style.width = Math.max(0, t - S) + '%'),
                            (x.style.left = t + '%'),
                            (x.style.transform = 'translate(-50%,0)'),
                            (x._gsap.x = '0px'),
                            (x._gsap.xPercent = -50),
                            B.startDrag(B.pointerEvent, !0));
                }),
                (this.animation = gp),
                (this.updateList = fp),
                re(this);
    ...
    (Ze.version = '3.12.3'),
        (Ze.globalRecordingTime = 2),
        (Ze.getById = function (e) {
            return e ? ge[e] : te;
        }),
        (Ze.getByAnimation = function (e) {
            for (var t in (ub(e) && (e = Q.getById(e)), ge))
                if (ge[t].animation() === e) return ge[t];
        }),
        (Ze.create = function (e) {
            return new Ze(e);
        }),
        (Ze.register = ac),
        tb() && Q.registerPlugin(Ze),
        (e.GSDevTools = Ze),
        (e.default = Ze);
