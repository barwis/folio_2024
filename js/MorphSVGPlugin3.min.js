!(function (t, e) {
    ...
    function da(t, e, n, r, o) {
        ...
        if (u[0]) {
            ...
            return (
                x && M('shapeIndex:[' + w.join(',') + ']'), (t.shapeIndex = w)
            );
        }
    }
    ...
    var a,
        ...
        J = {
            ...
            getRawPath: function getRawPath(t) {
                var e,
                    n = (t =
                        (m(t) && r.test(t) && document.querySelector(t)) || t)
                        .getAttribute
                        ? t
                        : 0;
